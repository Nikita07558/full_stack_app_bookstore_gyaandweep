  ...
  return (
    <>
     <div 
        ...
        style={{ backgroundImage: "url('https://wallpapercave.com/wp/M0Hy2Y0.jpg')" }} // Update the path to your image
      >
  ...
  <div className="modal-box">
    ...
    {/* email */}
     ...
     <div  className='mt-4 space-y-2'>
      ...
      <input type="text" name="" id="" placeholder='Enter your password' className='w-80 px-3 py-1 border rounded-md outline-none'
